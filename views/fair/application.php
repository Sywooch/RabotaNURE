...
<h2><?=Yii::t('app', 'Fair application')?></h2><br>
    ...
    <div class="col-md-12 col-sm-12">
	    ...
	    <div class="col-md-offset-3 col-md-9 col-sm-9 application-field-description">
...
Укажите контактную информацию для студентов по вопросам возможного трудоустройства (тел. и e-mail менеджера по персоналу).
    ...
    <div class="col-md-12 col-sm-12">
	    ...
	    <div class="col-md-offset-3 col-md-offset-3 col-md-9 col-sm-9 application-field-description">
    ...
    <div class="col-md-12 col-sm-12">
        ...
        <div class="form-group" style="padding-left:30px;">
            <?= Html::submitButton(Yii::t('app','Send application'), ['class' => 'btn btn-primary']) ?>
        </div>
    </div>
    <?php ActiveForm::end(); ?>
